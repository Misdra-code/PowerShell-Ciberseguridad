...
$sinLogon | Out-File -FilePath "C:\Users\yumel\OneDrive\Escritorio\PS\Actividad12_usuarios_sin_logon.txt"
$conLogon | Out-File -FilePath "C:\Users\yumel\OneDrive\Escritorio\PS\Actividad12_usuarios_con_logon.txt"
#Mostrar en pantalla
$reporte = @()
...
$reporte | Out-File -FilePath "C:\Users\yumel\OneDrive\Escritorio\PS\Actividad12_reporte_usuarios.txt"